...
$(function() {
	$("#release-sueescc").click(function() {
		$.ajax({
			url : "/ad/aorc",
			type : "POST",
			dataType : "JSON",
...
$(function() {
	...
	$("#changeTelephone").blur(function() {
		var changeTelephoneReg = /^1[3|4|5|8|7|][0-9]\d{4,8}$/;
		if (changeTelephoneReg.test($("#changeTelephone").val())) {
			$(".telephone span").remove();
		} else {
			$(".telephone").append("<span>号码有误</span>");
		}
	});
	...
	$("#content").blur(function() {
		...
		;
		filter($(this).val(), $(".content-sensitive"));
	});
	...
	$("#address").blur(function() {
		...
		;
		filter($(this).val(), $(".address-sensitive"));
	});

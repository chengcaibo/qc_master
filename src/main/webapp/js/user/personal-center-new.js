...
//初始化侧边栏颜色
function bgClor() {
    $(".personal-button li .icon-jibenxinxi").removeClass("i-button-bgcolor");
    $(".personal-button li .icon-jineng").removeClass("i-button-bgcolor");
    $(".personal-button li .icon-nickname").removeClass("i-button-bgcolor");
    $(".personal-button li .icon-youshi").removeClass("i-button-bgcolor");
    $(".personal-button li .icon-anli").removeClass("i-button-bgcolor");
    $(".personal-button li .icon-yuyue1").removeClass("i-button-bgcolor");
    $(".personal-button li .icon-tuandui").removeClass("i-button-bgcolor");
    $(".personal-button li .icon-guanzhu").removeClass("i-button-bgcolor");
    $(".personal-button li .icon-buchongiconsvg06").removeClass("i-button-bgcolor");
    $(".personal-button li .icon-jinlingyingcaiwangtubiao86").removeClass("i-button-bgcolor");
    $(".personal-button li .icon-icon-test").removeClass("i-button-bgcolor");
    $(".personal-button li .icon-photo").removeClass("i-button-bgcolor");
    $(".personal-button li .icon-fabu1").removeClass("i-button-bgcolor");
    $(".personal-button li .icon-fabuxuqiu").removeClass("i-button-bgcolor");
}

//初始化切换的页面
function display() {
    $("#basicInformation").css("display", "none");
    $("#comprehensiveSkills").css("display", "none");
    $("#myQualification").css("display", "none");
    $("#myAdvantage").css("display", "none");
    $("#successStories").css("display", "none");
    $("#reservationRecord").css("display", "none");
    $("#teamRecorded").css("display", "none");
    $("#advertisingRecord").css("display", "none");
    $("#myAttention").css("display", "none");
    $("#changePassword").css("display", "none");
    $("#identityDocuments").css("display", "none");
    $("#identityDocuments").css("display", "none");
    $("#head-portrait").css("display", "none");
    $("#releaseTime").css("display", "none");
    $("#demandRecord").css("display", "none");
}

$(function () {
    //个人中心的点击事件
    $(".personal-button li .icon-jibenxinxi").click(function () {
        bgClor();
        display();
        $(".personal-button li .icon-jibenxinxi").addClass("i-button-bgcolor");
        $("#basicInformation").css("display", "block");
    });
    $(".personal-button li .icon-jineng").click(function () {
        display();
        bgClor();
        $(".personal-button li .icon-jineng").addClass("i-button-bgcolor");
        $("#comprehensiveSkills").css("display", "block");
    });
    $(".personal-button li .icon-nickname").click(function () {
        display();
        bgClor();
        $(".personal-button li .icon-nickname").addClass("i-button-bgcolor");
        $("#myQualification").css("display", "block");
    });
    $(".personal-button li .icon-youshi").click(function () {
        bgClor();
        display();
        $(".personal-button li .icon-youshi").addClass("i-button-bgcolor");
        $("#myAdvantage").css("display", "block");
    });
    $(".personal-button li .icon-anli").click(function () {
        bgClor();
        display();
        $(".personal-button li .icon-anli").addClass("i-button-bgcolor");
        $("#successStories").css("display", "block");
    });
    $(".personal-button li .icon-yuyue1").click(function () {
        bgClor();
        display();
        $(".personal-button li .icon-yuyue1").addClass("i-button-bgcolor");
        $("#reservationRecord").css("display", "block");
    });
    $(".personal-button li .icon-tuandui").click(function () {
        bgClor();
        display();
        $(".personal-button li .icon-tuandui").addClass("i-button-bgcolor");
        $("#teamRecorded").css("display", "block");
    });
    $(".personal-button li .icon-guanzhu").click(function () {
        bgClor();
        display();
        $(".personal-button li .icon-guanzhu").addClass("i-button-bgcolor");
        $("#myAttention").css("display", "block");
    });
    $(".personal-button li .icon-buchongiconsvg06").click(function () {
        bgClor();
        display();
        $(".personal-button li .icon-buchongiconsvg06").addClass("i-button-bgcolor");
        $("#changePassword").css("display", "block");
    });
    $(".personal-button li .icon-jinlingyingcaiwangtubiao86").click(function () {
        bgClor();
        display();
        $(".personal-button li .icon-jinlingyingcaiwangtubiao86").addClass("i-button-bgcolor");
        $("#advertisingRecord").css("display", "block");
    });
    $(".personal-button li .icon-icon-test").click(function () {
        bgClor();
        display();
        $(".personal-button li .icon-icon-test").addClass("i-button-bgcolor");
        $("#identityDocuments").css("display", "block");
    });
    $(".personal-button li .icon-photo").click(function () {
        bgClor();
        display();
        $(".personal-button li .icon-photo").addClass("i-button-bgcolor");
        $("#head-portrait").css("display", "block");
    });
    $(".personal-button li .icon-fabu1").click(function () {
        bgClor();
        display();
        $(".personal-button li .icon-fabu1").addClass("i-button-bgcolor");
        $("#releaseTime").css("display", "block");
    });
    $(".personal-button li .icon-fabuxuqiu").click(function () {
        bgClor();
        display();
        $(".personal-button li .icon-fabuxuqiu").addClass("i-button-bgcolor");
        $("#demandRecord").css("display", "block");
    });

    switch (window.location.hash) {
        case "#local2":
            $(".personal-button li .icon-jineng").click();
            break;
        case "#local3":
            $(".personal-button li .icon-youshi").click();
            break;
        case "#local4":
            $(".personal-button li .icon-anli").click();
            break;
        case "#local5":
            $(".personal-button li .icon-yuyue1").click();
            break;
        case "#local6":
            $(".personal-button li .icon-tuandui").click();
            break;
        case "#local7":
            $(".personal-button li .icon-jinlingyingcaiwangtubiao86").click();
            break;
        case "#local8":
            $(".personal-button li .icon-guanzhu").click();
            break;
        case "#local9":
            $(".personal-button li .icon-buchongiconsvg06").click();
            break;
        case "#local10":
            $(".personal-button li .icon-nickname").click();
            break;
        case "#local11":
            $(".personal-button li .icon-icon-test").click();
            break;
        case "#local12":
            $(".personal-button li .icon-photo").click();
            break;
        case "#local13":
            $(".personal-button li .icon-fabu1").click();
            break;
        case "#local14":
            $(".personal-button li .icon-fabuxuqiu").click();
            break;
        default :
            $(".personal-button li .icon-jibenxinxi").click();
            break;
    }
